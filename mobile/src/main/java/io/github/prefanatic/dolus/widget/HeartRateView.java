package io.github.prefanatic.dolus.widget;
...
import io.github.prefanatic.dolus.R;
...
public class HeartRateView extends FrameLayout {
    ...
    private void init() {
        ...
        rate.setTextAppearance(android.support.v7.appcompat.R.style.TextAppearance_AppCompat_Display1);
